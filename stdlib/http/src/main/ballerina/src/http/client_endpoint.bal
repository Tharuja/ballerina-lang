...
#                     which references the persistent cookie handler or specifying a file path to be used in the default persistent cookie handler.
#                     If not specified, only session cookies are used
